/*
 * @(#)com.caih.caas.rtp.benchmark.AVReceive2.java	1.3 01/03/13
 *
...
/**
 * com.caih.caas.rtp.benchmark.AVReceive2 to receive RTP transmission using the new RTP API.
 */
public class AVReceive2 implements ReceiveStreamListener, SessionListener,
        ControllerListener {
    String bindIpAddr = null;
    String sessions[] = null;
    RTPManager mgrs[] = null;
    Vector<Object> playerWindows = null;

    boolean dataReceived = false;
    Object dataSync = new Object();


    public AVReceive2(String bindIpAddr, String sessions[]) {
    ...
    protected void close() {
        ...
        for (int i = 0; i < mgrs.length; i++) {
            if (mgrs[i] != null) {
                mgrs[i].removeTargets("Closing session from com.caih.caas.rtp.benchmark.AVReceive2");
                mgrs[i].dispose();
                mgrs[i] = null;
            }
        }
    ...
    public static void main(String argv[]) {
        ...
        AVReceive2 avReceive = new AVReceive2(argv[0], Arrays.copyOfRange(argv, 1, argv.length));
        if (!avReceive.initialize()) {
            System.err.println("Failed to initialize the sessions.");
            System.exit(-1);
        }

        // Check to see if com.caih.caas.rtp.benchmark.AVReceive2 is done.
        try {
    ...
    static void prUsage() {
        System.err.println("Usage: AVReceive2 <bindIPAddr> <session> <session> ...");
