...
public class JMFUtils {
    ...
    static final String ERR_PLAYER_CREATE_FOR = "Failed to create player for : ";
    ...
    public static MediaPlayer createMediaPlayer(String nameUrl, Frame frame,
        ...
        if (mediaLocator == null || nameUrl.equals("")) {
            System.err.println("Invalid media url: " + nameUrl);
            return (null);
        }
        ...
        if (mediaPlayer.getPlayer() == null) {
            System.err.println(ERR_PLAYER_CREATE_FOR + nameUrl);
            return (null);
        }
    ...
    public static MediaPlayer createMediaPlayer(DataSource dataSource, Frame frame) {
        ...
        if (dataSource == null) {
            System.err.println(ERR_PLAYER_CREATE_FOR + dataSource);
            return (null);
        }
    ...
    public static MediaPlayer createMediaPlayer(Player player, Frame frame) {
        ...
        if (player == null) {
            System.err.println(ERR_PLAYER_CREATE_FOR + player);
            return (null);
        }
